...
if(@$_GET['potion'] == "kmarst3") {
 echo "<div class='content'>";
 
 echo "<a href='https://magismo.ru/potions' style='color:#e0e0e0'>К списку рецептов</a> | <a href='https://magismo.ru/myroom/depo.php' style='color:#e0e0e0'>Депозитарий</a> |  <a href='https://magismo.ru/' style='color:#e0e0e0'>В Магисмо</a> 
<h3>ЗЕЛЬЕ ДЛЯ ТРЕТЬЕГО ТУРА ТУРНИРА ЧЕТЫРЁХ ВОЛШЕБНИКОВ</h3>
...
<b>Ингредиенты, которые нужно найти в алхимической лаборатории:</b>

<br>Вода родниковая (тем, кто нашёл ключ, вода будет выдана сразу/купить если не выдана)
<br>Аир болотный – 1 шт.
<br>Акварест мистический – 1 шт.
<br>Алоэ – 1 шт.
<br>Рог единорога – 1 шт.
<br>Бузина – 1 шт.
<br>Жёлудь – 1 шт.
<br>Габуркусы – 1 шт.
...
<br><br><b>Последовательность добавления ингредиентов в котел: <i style='color:#f6ff00'>На ваше усмотрение</i>
<br><br><b>Итоговые характеристики зелья:</b> <i style='color:#f6ff00'>На ваше усмотрение. Цвет зелья увидите в конце варки. </i>
...
if(@$_POST['begin']) {
    ...
    $check = mysqli_query($conn, "SELECT * FROM `potions` WHERE `login`='$login' and `lekvar`='kmarst3'");
    	if(!mysqli_num_rows($check)) {
    	$query = mysqli_query($conn, "INSERT INTO `potions` SET `login`='$login', `lekvar`='kmarst3', `sessionid`='$geid', `timestart`='$start', `timefinish`='',`progress`=1");    
    	}
